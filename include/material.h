...
struct material
{
	...
	material (color col, double ambient, double diffuse, double specular, double shinyness, double reflectiveness) : col(col), ambient(ambient), diffuse(diffuse), specular(specular), shinyness(shinyness), reflectiveness{reflectiveness} {}
